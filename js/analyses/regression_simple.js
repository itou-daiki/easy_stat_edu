                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>${tB0.toFixed(3)}</td>
                            <td style="${pB0 < 0.05 ? 'font-weight:bold; color:#ef4444;' : ''}">${pB0 < 0.001 ? '&lt; .001' : pB0.toFixed(4)} ${pB0 < 0.01 ? '**' : (pB0 < 0.05 ? '*' : (pB0 < 0.1 ? '†' : 'n.s.'))}</td>
                        </tr>
                        <tr>
                            <td>傾き (${xVar})</td>
                            <td>${b1.toFixed(3)}</td>
                            ...
                            <td style="${pValue < 0.05 ? 'font-weight:bold; color:#ef4444;' : ''}">${pValue < 0.001 ? '&lt; .001' : pValue.toFixed(4)} ${pValue < 0.01 ? '**' : (pValue < 0.05 ? '*' : (pValue < 0.1 ? '†' : 'n.s.'))}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="collapsible-section info-sections" style="margin-bottom: 2rem;">
                ...
                <div class="collapsible-content collapsed">
                    <div class="note">
                        ...
                        <img src="image/regression_simple.svg" alt="単回帰分析のイメージ" style="max-width: 100%; height: auto; margin-top: 1rem; border-radius: 8px; border: 1px solid #e2e8f0; display: block; margin-left: auto; margin-right: auto;">
                    </div>
                    <h4>どういう時に使うの？</h4>
                    <ul>
